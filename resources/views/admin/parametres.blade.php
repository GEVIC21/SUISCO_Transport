    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Paramètres</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <!--end::Flatpickr-->
                        <!--begin::Add product-->
                       {{-- <a href="../../demo1/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-instagram" ><i class="bi bi-plus-circle-fill"></i>Ajouter
                            Paramètre</a>--}}
                        <!--end::Add product-->
                    </div>
                    <!--end::Card toolbar-->
                        ...
                        @foreach($parameters as $parameter)
                            <tr>
                                ...
                                <td data-kt-ecommerce-order-filter="order_id">
                                    <span
                                       class="text-gray-800 text-hover-primary fw-bolder">{{$parameter->label}}
                                    </span>
                                </td>
                                <!--end::Order ID=-->
                                <!--begin::Customer=-->
                                <td>
                                    <div class="d-flex align-items-center">
                                        <!--begin::Title-->
                                        <span class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{$parameter->description}}</span>
                                        <!--end::Title-->
                                    </div>
                                </td>
                                <!--begin::Customer=-->
                                <td>
                                    <div class="d-flex align-items-center">
                                        <!--begin::Title-->
                                        <span class="text-gray-800">{{$parameter->value}}</span>
                                        <!--end::Title-->
                                    </div>
                                </td>
                                <!--end::Customer=-->
                                ...
                                <!--begin::Date Modified=-->
                                <td class="pe-0" >
                                    <span class="fw-bolder">{{$parameter->created_at}}</span>
                                </td>
                                <!--end::Date Modified=-->
                                <!--begin::Action=-->
                                <td class="text-end">

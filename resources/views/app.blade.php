@php
    ...
    $PermissionReservation = App\Models\PermissionRoleModel::getPermission('Reservation', Auth::user()->role_id);

    $PermissionDriver = App\Models\PermissionRoleModel::getPermission('Driver', Auth::user()->role_id);
    $PermissionConsignation = App\Models\PermissionRoleModel::getPermission('Consignation', Auth::user()->role_id);
    $PermissionEcole = App\Models\PermissionRoleModel::getPermission('Ecole', Auth::user()->role_id);
@endphp
...
<head>
    <base href="../">
    <title>Admin SUISCO TRANSPORT @yield('title') </title>
    <meta charset="utf-8" />
    ...
    <link rel="shortcut icon" href="template/bus/images/logo.png" />
    <!--begin::Fonts-->
    ...
    <style>
        .nav-link.collapsed::after {
            content: "▼"; /* Flèche pour le menu parent */
            transition: transform 0.3s;
            transform: rotate(0deg);
        }
        .nav-link:not(.collapsed)::after {
            content: "▼"; /* Flèche pour le menu parent lorsqu'il est ouvert */
            transform: rotate(180deg);
        }
        /* Aucun changement pour les sous-menus */
        .nav-item > .nav-link {
            position: relative; /* Pour enlever la flèche par défaut */
        }
    </style>
</head>
<!--end::Head-->
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="#">
                        <img alt="Logo" src="template/bus/images/logo.svg" class="h-50px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item menu-accordion">
                                <a class="menu-link @if (Route::currentRouteName() == 'admin.reservations') active @endif"
                            ...
                            <div class="menu-item menu-accordion">
                                <a class="menu-link @if (Route::currentRouteName() == 'admin.Consignations') active @endif"
                                    href="{{ route('admin.Consignations') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon">
                                    ...
                                    <span class="menu-title">Consignations</span>
                                </a>
                            </div>
                            <div class="menu-item menu-accordion">
                                <a class="menu-link @if (Route::currentRouteName() == 'admin.ecoles') active @endif"
                            ...
                            <div class="d-flex flex-column p-3 " style="width: 150px;">
                                <ul class="nav nav-pills flex-column mb-auto">
                                    <li class="nav-item">
                                        <a href="#submenu1" data-bs-toggle="collapse" class="nav-link link-dark d-flex justify-content-between align-items-center collapsed" aria-expanded="false">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="black" />
                                                    <rect x="11" y="14" width="7" height="2" rx="1" fill="black" />
                                                    <rect x="6" y="10" width="12" height="2" rx="1" fill="black" />
                                                    <rect x="11" y="6" width="7" height="2" rx="1" fill="black" />
                                                </svg>
                                                <!--end::Svg Icon-->
                                            </span>
                                        ...
                                        <ul class="collapse nav flex-column ms-1" id="submenu1">
                                            <li class="nav-item">
                                                <a href="{{ route('admin.chauffeur') }}" class="nav-link link-dark">Chauffeur</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('admin.parent') }}" class="nav-link link-dark">Parent</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                    <form method="POST" action="{{ route('logout') }}" class="m-0">
                        @csrf
                        <button type="submit" class="btn btn-custom btn-instagram btn-active-color-warning w-100"
                                data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-dismiss-="click" title="Cliquez pour vous déconnecter">
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="/reservations" class="d-lg-none">
                                <img alt="Logo" src="template/bus/images/logo.png" class="h-30px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                        <!--begin::Wrapper-->
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div data-kt-menu-placement="bottom-start"
                                            ...
                                            <a class="menu-link py-3 @if (Route::currentRouteName() == 'admin.reservations') active @endif"
                                                href="{{ route('admin.reservations') }}">
                                                <span class="menu-title">Réservations</span>
                                        ...
                                        <div data-kt-menu-placement="bottom-start"
                                            class="menu-item  menu-lg-down-accordion me-lg-1">
                                            <a class="menu-link py-3 @if (Route::currentRouteName() == 'admin.Consignations') active @endif"
                                                href="{{ route('admin.Consignations') }}">
                                                <span class="menu-title">Consignations</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </a>
                                        ...
                                        <div data-kt-menu-placement="bottom-start"
                                            class="menu-item menu-lg-down-accordion me-lg-1">
                                            <a class="menu-link py-3 @if (Route::currentRouteName() == 'admin.parametres') active @endif"
                                                href="{{ route('admin.parametres') }}">
                                                <span class="menu-title">Paramètres</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </a>
                                        ...
                                        <div data-kt-menu-placement="bottom-start"
                                            class="menu-item menu-lg-down-accordion me-lg-1">
                                            <a class="menu-link py-3 @if (Route::currentRouteName() == 'admin.utilisateurs') active @endif"
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                                        {{ auth()->user()->name }}
                                                        <span
                                                            class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">User-Admin</span>
                                                    </div>
                                                    <a href="#"
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="{{ route('admin.update.utilisateur', auth()->user()->id) }}"
                                        ...
                                        <div class="menu-item px-5">
                                            <form method="POST" action="{{ route('logout') }}" class="m-0">
                                                @csrf
                                                <button type="submit" class="menu-link px-5" style="background: none; border: none; cursor: pointer;">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank"
                                class="text-gray-800 text-hover-primary">Itplex | Suisco</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
                        <!--end::Menu-->

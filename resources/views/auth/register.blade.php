...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Suisco Transport Login</title>
		<meta charset="utf-8" />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="/" class="mb-12">
						<img alt="Logo" src="template/bus/images/logo.svg" class="h-100px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{route('register')}}" method="POST">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Suisco Transport</h1>
								<!--end::Title-->
								<!--begin::Link-->
                                <div class="text-gray-400 fw-bold fs-4">Admin</div>
								<!--end::Link-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								<!--begin::Label-->
								<label class="form-label fs-6 fw-bolder text-dark">Nom</label>
								<!--end::Label-->
								<!--begin::Input-->
				...
				<div class="d-flex flex-center flex-column-auto p-10">
					...
					<div class="d-flex align-items-center fw-bold fs-6">
						<a href="https://keenthemes.com" class="text-muted text-hover-primary px-2">Iptlex | 2024</a>
					</div>
					<!--end::Links-->
				</div>
				<!--end::Footer-->
